...
class MakePagesStretching extends StatefulWidget {
  final Workout train;
  const MakePagesStretching({super.key, required this.train});

  @override
  State<MakePagesStretching> createState() => _MakePagesState();
}

class _MakePagesState extends State<MakePagesStretching> {
  ...
  bool _isSelected() {
    final shop = context.read<ChooseStretching>();
